...
public abstract class MeasureFormat extends Format {
    ...
    static final class NumberUnit extends MeasureFormat {
        ...
        public NumberUnit(NumberFormat numberFormat, UnitFormat unitFormat) {
        ...
        public Object parseCompound(Number highValue, String source,
        ...
        @SuppressWarnings("unchecked")
        public static Measure measureOf(Number value, Unit unit) {
