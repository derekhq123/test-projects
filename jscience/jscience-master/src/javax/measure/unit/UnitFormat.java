...
public abstract class UnitFormat extends Format {
    ...
    protected static class DefaultFormat extends UnitFormat {
        ...
        public int nextToken(CharSequence csq, ParsePosition pos) {
        ...
        public void check(boolean expr, String message, CharSequence csq,
        ...
        public Exponent readExponent (CharSequence csq, ParsePosition pos) {
            char c = csq.charAt(pos.getIndex());
            if (c == '^') {
                pos.setIndex(pos.getIndex()+1);
            } else if (c == '*') {
        ...
        public long readLong (CharSequence csq, ParsePosition pos) {
            final int length = csq.length();
            int result = 0;
        ...
        public double readDouble (CharSequence csq, ParsePosition pos) {
            final int length = csq.length();
            int start = pos.getIndex();
            int end = start+1;
            while (end < length) {
        ...
        public String readIdentifier(CharSequence csq, ParsePosition pos) {
            final int length = csq.length();
            int start = pos.getIndex();
            int i = start;
        ...
        public void append(Appendable appendable, CharSequence symbol,
    ...
    public static String asciiPrefix(String prefix) {
