...
public final class Real extends Number<Real> implements Field<Real> {
    ...
    public static LargeInteger div(int exp, LargeInteger significand) {
	...
	public void set_exponent(int _exponent) {
		this._exponent = _exponent;
	}

	public void set_error(LargeInteger _error) {
		this._error = _error;
	}

	public void set_significand(LargeInteger _significand) {
