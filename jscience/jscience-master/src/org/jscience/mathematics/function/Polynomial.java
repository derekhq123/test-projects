...
public class Polynomial<R extends Ring<R>> extends Function<R, R> implements 
    ...
    public static boolean isZero(GroupAdditive<?> coefficient) {
    ...
    public static <R extends Ring<R>> R multiply(R o, int n) {
        if (n <= 0)
    ...
    @SuppressWarnings("unchecked")
    public static <R extends Ring<R>> Polynomial<R> newInstance() {
