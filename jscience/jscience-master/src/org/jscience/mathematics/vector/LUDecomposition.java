...
public final class LUDecomposition<F extends Field<F>>  {
     ...
     */
    public void construct(Matrix<F> source) {
    ...
    public DenseMatrix<F> createNullDenseMatrix(int m, int n) {
    ...
    private static final ObjectFactory<LUDecomposition> FACTORY = new ObjectFactory<LUDecomposition>() {
        ...
        @SuppressWarnings("unchecked")
        public void cleanup(LUDecomposition lu) {
            lu._LU = null;
        }
    };
	...
	public void set_permutationCount(int _permutationCount) {
		this._permutationCount = _permutationCount;
	}
