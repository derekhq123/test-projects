...
public class CompoundCRS<C1 extends Coordinates<?>, C2 extends Coordinates<?>>
    ...
    @Override
    public CompoundCoordinates<C1, C2> coordinatesOf(AbsolutePosition position) {
    ...
    @Override
    public AbsolutePosition positionOf(CompoundCoordinates<C1, C2> coordinates, AbsolutePosition position) {
