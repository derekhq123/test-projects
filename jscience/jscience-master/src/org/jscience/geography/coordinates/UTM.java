...
public final class UTM extends Coordinates<ProjectedCRS<?>> {
    ...
    public static final ProjectedCRS<UTM> CRS = new ProjectedCRS<UTM>() {
        ...
        @Override
        public UTM coordinatesOf(AbsolutePosition position) {
        ...
        @Override
        public AbsolutePosition positionOf(UTM coordinates,
	...
	public void set_northing(double _northing) {
		this._northing = _northing;
	}

	public void set_easting(double _easting) {
		this._easting = _easting;
	}

	public void set_latitudeZone(char _latitudeZone) {
		this._latitudeZone = _latitudeZone;
	}

	public void set_longitudeZone(int _longitudeZone) {
		this._longitudeZone = _longitudeZone;
	}
