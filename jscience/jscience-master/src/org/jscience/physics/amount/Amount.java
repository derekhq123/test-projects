...
////////////////////////////////////////////////////////////////////////////////
    ...
    public static synchronized Unit<?> calculateProductOf(final Unit<?> left, final Unit<?> right) {
    ...
    public static synchronized Unit<?> calculateInverseOf(final Unit<?> unit) {
    ...
    public static synchronized UnitConverter calculateConverterOf(final Unit<?> left,
            final Unit<?> right) {
    ...
    @SuppressWarnings("unchecked")
    public static <Q extends Quantity> Amount<Q> copyOf(Amount original) {
        Amount<Q> measure = FACTORY.object();
    ...
    public Amount<Q> setExact(long exactValue) {
        _isExact = true;
	...
	public void set_maximum(double _maximum) {
		this._maximum = _maximum;
	}

	public void set_minimum(double _minimum) {
		this._minimum = _minimum;
	}

	public void set_exactValue(long _exactValue) {
		this._exactValue = _exactValue;
	}

	public void set_isExact(boolean _isExact) {
		this._isExact = _isExact;
	}
