 ...
 */
public synchronized DoubleArrayList elements_unsafe() {
...
public static boolean includes(double[] array1, double[] array2, int first1, int last1,	int first2,	int last2) {
 ...
 */
public synchronized cern.colt.map.AbstractDoubleIntMap frequencyMap() {
 ...
 */
public synchronized DoubleArrayList sortedElements_unsafe() {
	sort();
 ...
 * 
 */
public void updateIncrementalStats() {
	// prepare arguments
 ...
 * 
 */
public void updateSumOfInversions() {
 ...
 * 
 */
public void updateSumOfLogarithms() {
...
public void setIsSumOfLogarithmsValid(boolean isSumOfLogarithmsValid) {
	this.isSumOfLogarithmsValid = isSumOfLogarithmsValid;
}
public void setIsSumOfInversionsValid(boolean isSumOfInversionsValid) {
	this.isSumOfInversionsValid = isSumOfInversionsValid;
}
public void setIsIncrementalStatValid(boolean isIncrementalStatValid) {
	this.isIncrementalStatValid = isIncrementalStatValid;
}
public void setIsSorted(boolean isSorted) {
	this.isSorted = isSorted;
}
public void setSortedElements(DoubleArrayList sortedElements) {
	this.sortedElements = sortedElements;
}
public void setElements(DoubleArrayList elements) {
