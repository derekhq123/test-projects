 ...
 */
public boolean xequals(Object object) {
 ...
 */
public boolean xhasSumOfPowers(int fromK, int toK) {
 ...
 */
public synchronized boolean xisLegalOrder(int k) {
	return getMinOrderForSumOfPowers() <= k && k <= getMaxOrderForSumOfPowers();
}
public void setSumOfPowers(double[] sumOfPowers) {
	this.sumOfPowers = sumOfPowers;
}
public void setSumOfInversions(double sumOfInversions) {
	this.sumOfInversions = sumOfInversions;
}
public void setHasSumOfInversions(boolean hasSumOfInversions) {
	this.hasSumOfInversions = hasSumOfInversions;
}
public void setSumOfLogarithms(double sumOfLogarithms) {
	this.sumOfLogarithms = sumOfLogarithms;
}
public void setHasSumOfLogarithms(boolean hasSumOfLogarithms) {
	this.hasSumOfLogarithms = hasSumOfLogarithms;
}
}
