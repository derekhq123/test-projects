...
public class Histogram3D extends AbstractHistogram3D implements IHistogram3D
{
	 ...
	 */
	public IHistogram2D internalSliceXY(String title, int indexZ1, int indexZ2)
	{
	 ...
	 * <b>Note 3</b>There is no note 3 (yet)
	 */
	public IHistogram2D internalSliceXZ(String title, int indexY1, int indexY2)
	{
		// Attention: our internal definition of bins has been choosen
		// so that this works properly even if the indeces passed in include
		// the underflow or overflow bins
	 ...
	 * <b>Note 3</b>There is no note 3 (yet)
	 */
	public IHistogram2D internalSliceYZ(String title, int indexX1, int indexX2)
	{
		// Attention: our internal definition of bins has been choosen
		// so that this works properly even if the indeces passed in include
		// the underflow or overflow bins
	...
	public void setSumWeightSquared(double sumWeightSquared) {
