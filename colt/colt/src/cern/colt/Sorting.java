 ...
 * Returns the index of the median of the three indexed chars.
 */
public static int med3(Object x[], int a, int b, int c) {
 ...
 * Returns the index of the median of the three indexed chars.
 */
public static int med3(Object x[], int a, int b, int c, Comparator comp) {
	int ab = comp.compare(x[a],x[b]);
	int ac = comp.compare(x[a],x[c]);
	int bc = comp.compare(x[b],x[c]);
	return (ab<0 ?
...
public static void mergeSort1(byte src[], byte dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(byte src[], byte dest[], int low, int high, ByteComparator c) {
	int length = high - low;
...
public static void mergeSort1(char src[], char dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(char src[], char dest[], int low, int high, CharComparator c) {
	int length = high - low;
...
public static void mergeSort1(double src[], double dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(double src[], double dest[], int low, int high, DoubleComparator c) {
	int length = high - low;
...
public static void mergeSort1(float src[], float dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(float src[], float dest[], int low, int high, FloatComparator c) {
	int length = high - low;
...
public static void mergeSort1(int src[], int dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(int src[], int dest[], int low, int high, IntComparator c) {
	int length = high - low;
...
public static void mergeSort1(long src[], long dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(long src[], long dest[], int low, int high, LongComparator c) {
	int length = high - low;
...
public static void mergeSort1(short src[], short dest[], int low, int high) {
	int length = high - low;
...
public static void mergeSort1(short src[], short dest[], int low, int high, ShortComparator c) {
	int length = high - low;
...
public static void mergeSort2(double a[], int fromIndex, int toIndex) {
rangeCheck(a.length, fromIndex, toIndex);
...
public static void mergeSort2(float a[], int fromIndex, int toIndex) {
rangeCheck(a.length, fromIndex, toIndex);
 ...
 */
public static void quickSort1(byte x[], int off, int len, ByteComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(char x[], int off, int len, CharComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(double x[], int off, int len, DoubleComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(float x[], int off, int len, FloatComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(int x[], int off, int len, IntComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(long x[], int off, int len, LongComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(Object x[], int off, int len) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
	    for (int i=off; i<len+off; i++)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(Object x[], int off, int len, Comparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
 ...
 * Sorts the specified sub-array of chars into ascending order.
 */
public static void quickSort1(short x[], int off, int len, ShortComparator comp) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
		for (int i=off; i<len+off; i++)
		for (int j=i; j>off && comp.compare(x[j-1],x[j])>0; j--)
...
public static void swap(short x[], int a, int b) {
	 ...
	 */
	public static void vecswap(byte x[], int a, int b, int n) {
	 ...
	 * Swaps x[a .. (a+n-1)] with x[b .. (b+n-1)].
	 */
	public static void vecswap(double x[], int a, int b, int n) {
	for (int i=0; i<n; i++, a++, b++)
	    swap(x, a, b);
	}
	/**
	 * Swaps x[a .. (a+n-1)] with x[b .. (b+n-1)].
	 */
	public static void vecswap(float x[], int a, int b, int n) {
	for (int i=0; i<n; i++, a++, b++)
	    swap(x, a, b);
	}
	/**
	 ...
	 * Swaps x[a .. (a+n-1)] with x[b .. (b+n-1)].
	 */
	public static void vecswap(long x[], int a, int b, int n) {
	for (int i=0; i<n; i++, a++, b++)
	    swap(x, a, b);
	}
	/**
	 * Swaps x[a .. (a+n-1)] with x[b .. (b+n-1)].
	 */
	public static void vecswap(Object x[], int a, int b, int n) {
	for (int i=0; i<n; i++, a++, b++)
	    swap(x, a, b);
	}
	/**
	 * Swaps x[a .. (a+n-1)] with x[b .. (b+n-1)].
	 */
	public static void vecswap(short x[], int a, int b, int n) {
	for (int i=0; i<n; i++, a++, b++)
	    swap(x, a, b);
	}
}
