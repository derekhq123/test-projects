...
public void setZList(IntArrayList zList) {
	this.zList = zList;
}
public void setYList(IntArrayList yList) {
	this.yList = yList;
}
public void setXList(IntArrayList xList) {
	this.xList = xList;
}
public void setZElements(int[] zElements) {
	this.zElements = zElements;
}
public void setYElements(int[] yElements) {
	this.yElements = yElements;
}
public void setXElements(int[] xElements) {
	this.xElements = xElements;
}
public void setTarget(IntBuffer3DConsumer target) {
	this.target = target;
}
}
