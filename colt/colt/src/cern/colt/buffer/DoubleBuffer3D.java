...
public void setZList(DoubleArrayList zList) {
	this.zList = zList;
}
public void setYList(DoubleArrayList yList) {
	this.yList = yList;
}
public void setXList(DoubleArrayList xList) {
	this.xList = xList;
}
public void setZElements(double[] zElements) {
	this.zElements = zElements;
}
public void setYElements(double[] yElements) {
	this.yElements = yElements;
}
public void setXElements(double[] xElements) {
	this.xElements = xElements;
}
public void setTarget(DoubleBuffer3DConsumer target) {
	this.target = target;
}
}
