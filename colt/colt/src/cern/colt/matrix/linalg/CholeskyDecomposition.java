...
@exception  IllegalArgumentException  if <tt>!isSymmetricPositiveDefinite()</tt>.
*/
public DoubleMatrix2D XXXsolveBuggy(DoubleMatrix2D B) {
...
public void setIsSymmetricPositiveDefinite(boolean isSymmetricPositiveDefinite) {
	this.isSymmetricPositiveDefinite = isSymmetricPositiveDefinite;
}
public void setN(int n) {
	this.n = n;
}
public void setL(DoubleMatrix2D L) {
	this.L = L;
}
}
