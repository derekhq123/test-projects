 ...
 */
public CholeskyDecomposition chol(DoubleMatrix2D matrix) {
 ...
 */
public EigenvalueDecomposition eig(DoubleMatrix2D matrix) {
 ...
 */
public LUDecomposition lu(DoubleMatrix2D matrix) {
 ...
 */
public QRDecomposition qr(DoubleMatrix2D matrix) {
 ...
 */
public SingularValueDecomposition svd(DoubleMatrix2D matrix) {
