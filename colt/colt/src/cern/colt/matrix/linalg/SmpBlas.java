...
*/
public SmpBlas(int maxThreads, Blas seqBlas) {
...
public double[] run(DoubleMatrix2D A, DoubleMatrix2D B, boolean collectResults, Matrix2DMatrix2DFunction fun) {
...
public double[] run(DoubleMatrix2D A, boolean collectResults, Matrix2DMatrix2DFunction fun) {
	DoubleMatrix2D[] blocks;
...
public double xsum(DoubleMatrix2D A) {
...
public void setNN_THRESHOLD(int NN_THRESHOLD) {
	this.NN_THRESHOLD = NN_THRESHOLD;
}
...
public void setSeqBlas(Blas seqBlas) {
	this.seqBlas = seqBlas;
}
public void setSmpBlas(Blas smpBlas) {
	this.smpBlas = smpBlas;
}
}
