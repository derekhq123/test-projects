 ...
 * @param  offset   
 */
public SelectedSparseObjectMatrix2D(int rows, int columns, AbstractIntObjectMap elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 * @param  offset   
 */
public SelectedSparseObjectMatrix2D(AbstractIntObjectMap elements, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 * </ul>
 */
public boolean haveSharedCellsRaw(ObjectMatrix2D other) {
