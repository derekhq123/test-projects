 ...
 */
public SelectedSparseDoubleMatrix3D(AbstractIntDoubleMap elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 * </ul>
 */
public boolean haveSharedCellsRaw(DoubleMatrix3D other) {
 ...
 */
public DoubleMatrix2D like2D(int rows, int columns, int rowZero, int columnZero, int rowStride, int columnStride) {
 ...
 * @return  a new view.
 */
public DoubleMatrix3D viewSelectionLike(int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets) {
...
public void setElements(AbstractIntDoubleMap elements) {
	this.elements = elements;
}
}
