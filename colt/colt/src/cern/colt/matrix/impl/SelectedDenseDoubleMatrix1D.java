 ...
 */
public SelectedDenseDoubleMatrix1D(double[] elements, int[] offsets) {
 ...
 * @param offset   
 */
public SelectedDenseDoubleMatrix1D(int size, double[] elements, int zero, int stride, int[] offsets, int offset) {
