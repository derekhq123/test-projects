 ...
 */
public SparseDoubleMatrix2D(int rows, int columns, AbstractIntDoubleMap elements, int rowZero, int columnZero, int rowStride, int columnStride) {
 ...
 * @return  a new matrix of the corresponding dynamic type.
 */
public DoubleMatrix1D like1D(int size, int offset, int stride) {
