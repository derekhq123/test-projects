 ...
 * @param offset   
 */
public SelectedSparseObjectMatrix1D(int size, AbstractIntObjectMap elements, int zero, int stride, int[] offsets, int offset) {
 ...
 * @return  a new view.
 */
public ObjectMatrix1D viewSelectionLike(int[] offsets) {
