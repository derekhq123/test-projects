 ...
 */
public SelectedSparseObjectMatrix3D(AbstractIntObjectMap elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 * </ul>
 */
public boolean haveSharedCellsRaw(ObjectMatrix3D other) {
 ...
 */
public ObjectMatrix2D like2D(int rows, int columns, int rowZero, int columnZero, int rowStride, int columnStride) {
 ...
 */
public void setUp(int slices, int rows, int columns) {
 ...
 * @return  a new view.
 */
public ObjectMatrix3D viewSelectionLike(int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets) {
...
public void setColumnOffsets(int[] columnOffsets) {
	this.columnOffsets = columnOffsets;
}
public void setRowOffsets(int[] rowOffsets) {
	this.rowOffsets = rowOffsets;
}
public void setSliceOffsets(int[] sliceOffsets) {
	this.sliceOffsets = sliceOffsets;
}
public void setElements(AbstractIntObjectMap elements) {
	this.elements = elements;
}
}
