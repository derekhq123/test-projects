 ...
 * @param offset   
 */
public SelectedSparseDoubleMatrix1D(int size, AbstractIntDoubleMap elements, int zero, int stride, int[] offsets, int offset) {
 ...
 */
public boolean haveSharedCellsRaw(DoubleMatrix1D other) {
 ...
 * @return  a new view.
 */
public DoubleMatrix1D viewSelectionLike(int[] offsets) {
