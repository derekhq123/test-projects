 ...
 * Converts a given cell to a String; no alignment considered.
 */
public String form(AbstractMatrix1D matrix, int index, Former formatter) {
 ...
 * Returns a string representations of all cells; no alignment considered.
 */
public String[][] format(AbstractMatrix2D matrix) {
...
*/
public String toTitleString(DoubleMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title) {
...
@return the matrix converted to a string.
*/
public String xtoTitleString(DoubleMatrix3D matrix, String[] sliceNames, String[] rowNames, String[] columnNames, String sliceAxisName, String rowAxisName, String columnAxisName, String title) {
	if (matrix.size()==0) return "Empty matrix";
	StringBuffer buf = new StringBuffer();
	for (int i=0; i<matrix.slices(); i++) {
		if (i!=0) buf.append(sliceSeparator);
