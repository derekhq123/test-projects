 ...
 */
public boolean haveSharedCells(ObjectMatrix2D other) {
 ...
 * @return  a new matrix of the corresponding dynamic type.
 */
public abstract ObjectMatrix1D like1D(int size, int zero, int stride);
/**
 ...
 * @return  a new view.
 */
public abstract ObjectMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets);
/**
