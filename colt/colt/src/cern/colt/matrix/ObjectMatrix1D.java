 ...
 */
public ObjectMatrix1D getContent() {
	return this;
}
/**
 ...
 */
public boolean haveSharedCells(ObjectMatrix1D other) {
 ...
 * Returns <tt>true</tt> if both matrices share at least one identical cell.
 */
public boolean haveSharedCellsRaw(ObjectMatrix1D other) {
	return false;
}	
/**
 ...
 * @return  a new view.
 */
public abstract ObjectMatrix1D viewSelectionLike(int[] offsets);
/**
