 ...
 */
public boolean haveSharedCells(DoubleMatrix3D other) {
 ...
 */
public abstract DoubleMatrix2D like2D(int rows, int columns, int rowZero, int columnZero, int rowStride, int columnStride);
/**
 ...
 */
public boolean xforEach(final cern.colt.function.DoubleProcedure procedure) {
	for (int slice=slices; --slice >= 0;) {
		for (int row=rows; --row >= 0;) {
			for (int column=columns; --column >= 0;) {
