 ...
 */
public BenchmarkMatrix() {}
/**
 * Not yet documented.
 */
public static void bench_dgemm(String[] args) {
	String[] types;
	int cpus;
	double minSecs;
	boolean transposeA;
 ...
 * Not yet documented.
 */
public static void bench_dgemv(String[] args) {
	String[] types;
	int cpus;
	double minSecs;
	boolean transposeA;
 ...
 * Not yet documented.
 */
public static void bench_pow(String[] args) {
	String[] types;
	int cpus;
	double minSecs;
	double[] densities;
 ...
 * Not yet documented.
 */
public static void benchGeneric(Double2DProcedure fun, String[] args) {
	String[] types;
	int cpus;
	double minSecs;
	double[] densities;
 ...
 */
public static Double2DProcedure fun_dgemm(final boolean transposeA, final boolean transposeB) {
 ...
 * Linear algebrax matrix-matrix multiply.
 */
public static Double2DProcedure fun_dgemv(final boolean transposeA) {
	return new Double2DProcedure() { 
 ...
 */
public static Double2DProcedure fun_pow(final int k) {
	return new Double2DProcedure() {
		public double dummy;
 ...
 */
public static Double2DProcedure funAssign() {
	return new Double2DProcedure() {
 ...
 * 2D assign with get,set
 */
public static Double2DProcedure funAssignGetSet() {
	return new Double2DProcedure() { 
 ...
 */
public static Double2DProcedure funAssignGetSetQuick() {
	return new Double2DProcedure() { 
 ...
 * 2D assign with A.assign(B)
 */
public static Double2DProcedure funAssignLog() {
	return new Double2DProcedure() { 
 ...
 * 2D assign with A.assign(B)
 */
public static Double2DProcedure funAssignPlusMult() {
	return new Double2DProcedure() { 
 ...
 * Linear algebrax matrix-matrix multiply.
 */
public static Double2DProcedure funCorrelation() {
	return new Double2DProcedure() { 
 ...
 */
public static Double2DProcedure funElementwiseMult() {
	return new Double2DProcedure() { 
 ...
 * Element-by-element matrix-matrix multiply.
 */
public static Double2DProcedure funElementwiseMultB() {
	return new Double2DProcedure() { 
 ...
 * 2D assign with get,set
 */
public static Double2DProcedure funGetQuick() {
	return new Double2DProcedure() {
		public double dummy;
		public String toString() { return "xxxxxxx";	}
		public void init() {}		
 ...
 * 2D assign with getQuick,setQuick
 */
public static Double2DProcedure funLUDecompose() {
	return new Double2DProcedure() {
 ...
 * 2D assign with getQuick,setQuick
 */
public static Double2DProcedure funLUSolve() {
	return new Double2DProcedure() {
 ...
 * Linear algebrax matrix-matrix multiply.
 */
public static Double2DProcedure funMatMultLarge() {
	return new Double2DProcedure() {
		public String toString() { return "xxxxxxx";	}
		public void setParameters(DoubleMatrix2D A, DoubleMatrix2D B) {
 ...
 */
public static Double2DProcedure funMatVectorMult() {
	return new Double2DProcedure() { 
		public String toString() { return "xxxxxxx";	}
		public void setParameters(DoubleMatrix2D G, DoubleMatrix2D H) {
			super.setParameters(G,H);
 ...
 * 2D assign with get,set
 */
public static Double2DProcedure funSetQuick() {
	return new Double2DProcedure() {
		private int current;
 ...
 * 
 */
public static Double2DProcedure funSOR5() {
	return new Double2DProcedure() {
		double value = 2; 
		double omega = 1.25;
 ...
 * 
 */
public static Double2DProcedure funSOR8() {
	return new Double2DProcedure() {
		double value = 2;
		double omega = 1.25;
		final double alpha = omega * 0.25;
 ...
 * 
 */
public static Double2DProcedure funSort() {
	return new Double2DProcedure() { 
		public String toString() { return "xxxxxxx";	}
		public void init() { A.assign(C); }
 ...
 * Not yet documented.
 */
public static DoubleFactory2D getFactory(String type) {
 ...
 * Not yet documented.
 */
public static Double2DProcedure getGenericFunction(String cmd) {
 ...
 * Executes a command
 */
public static boolean handle(String[] params) {
 ...
 */
public static void run(double minSeconds, String title, Double2DProcedure function, String[] types, int[] sizes, double[] densities) {
 ...
 * Executes procedure repeatadly until more than minSeconds have elapsed.
 */
public static void runSpecial(double minSeconds, String title, Double2DProcedure function) {
	int[] sizes =        {10000};
