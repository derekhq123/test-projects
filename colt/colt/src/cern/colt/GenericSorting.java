 ...
 * second.
 */
public static void inplace_merge(int first, int middle, int last, IntComparator comp, Swapper swapper) {
 ...
 */
public static void quickSort1(int off, int len, IntComparator comp, Swapper swapper) {
	// Insertion sort on smallest arrays
	if (len < SMALL) {
 ...
 *                   is invalid.
 */
public static void reverse(int first, int last, Swapper swapper) {
 ...
 */
public static void vecswap(Swapper swapper, int a, int b, int n) {
