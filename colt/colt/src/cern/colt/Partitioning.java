...
*/
public static int binarySearchFromTo(int a, int from, int to, IntComparator comp) {
	while (from <= to) {
		int mid = (from + to) / 2;
...
*/
public static int genericPartition(int from, int to, int splitter, IntComparator comp, Swapper swapper) {
	for (int i=from-1; ++i<=to; ) {
 ...
 */
public static int med3(Object x[], int a, int b, int c, java.util.Comparator comp) {
...
public void setSwappedElements(int swappedElements) {
	this.swappedElements = swappedElements;
}
