...
public static double fc_lnpk(int k, int N_Mn, int M, int n) {
 ...
 */
public int hmdu(int N, int M, int n, RandomEngine randomGenerator) {
 ...
 * Returns a random number from the distribution.
 */
public int hprs(int N, int M, int n,  RandomEngine randomGenerator) {
	int    Dk, X, V;
 ...
 * Returns a random number from the distribution; bypasses the internal state.
 */
public int nextInt(int N, int M, int n, RandomEngine randomGenerator) {
/******************************************************************
 *                                                                *
...
public void setShared(HyperGeometric shared) {
	this.shared = shared;
}
...
public void setN_Mn(int N_Mn) {
	this.N_Mn = N_Mn;
}
public void setN_last(int N_last) {
	this.N_last = N_last;
}
public void setMy_n(int my_n) {
	this.my_n = my_n;
}
public void setMy_s(int my_s) {
	this.my_s = my_s;
}
public void setMy_N(int my_N) {
	this.my_N = my_N;
