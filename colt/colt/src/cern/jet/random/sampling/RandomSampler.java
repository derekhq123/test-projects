 ...
 */
public static void rejectMethodD(long n, long N, int count, long low, long[] values, int fromIndex, RandomEngine randomGenerator) {
 ...
 * @param randomGenerator a random number generator.
 */
public static void sampleMethodA(long n, long N, int count, long low, long[] values, int fromIndex, RandomEngine randomGenerator) {
 ...
 * @param randomGenerator a random number generator.
 */
public static void sampleMethodD(long n, long N, int count, long low, long[] values, int fromIndex, RandomEngine randomGenerator) {
	double nreal, Nreal, ninv, nmin1inv, U, X, Vprime, y1, y2, top, bottom, negSreal, qu1real;
 ...
 */
public static void testNegAlphaInv(String args[]) {
	/*
	long N = Long.parseLong(args[0]);
...
public void setMy_RandomGenerator(RandomEngine my_RandomGenerator) {
	this.my_RandomGenerator = my_RandomGenerator;
}
public void setMy_low(long my_low) {
	this.my_low = my_low;
}
public void setMy_N(long my_N) {
	this.my_N = my_N;
}
public void setMy_n(long my_n) {
	this.my_n = my_n;
