 ...
 */
public void xsampleNextElements(BooleanArrayList acceptList) {
	// manually inlined
...
public void setGenerator(Uniform generator) {
	this.generator = generator;
}
public void setNextSkip(int nextSkip) {
	this.nextSkip = nextSkip;
}
public void setNextTriggerPos(int nextTriggerPos) {
	this.nextTriggerPos = nextTriggerPos;
}
