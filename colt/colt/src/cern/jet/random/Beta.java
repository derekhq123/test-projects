 ...
 * 
 */
public double b00(double a, double b, RandomEngine randomGenerator) {
	double             U, V, X, Z;
 ...
 * 
 */
public double b01(double a, double b, RandomEngine randomGenerator) {
	double             U, V, X, Z;
 ...
 * 
 */
public double b1prs(double p, double q, RandomEngine randomGenerator) {
	double            U, V, W, X, Y;
...
public static double f(double x, double a, double b, double m) {
 ...
 */
public static void xstaticSetRandomGenerator(RandomEngine randomGenerator) {
	synchronized (shared) {
		shared.setRandomGenerator(randomGenerator);
	}
}
public void setShared(Beta shared) {
	this.shared = shared;
}
...
public void setA_(double a_) {
	this.a_ = a_;
}
public void setA_last(double a_last) {
	this.a_last = a_last;
}
public void setPDF_CONST(double PDF_CONST) {
	this.PDF_CONST = PDF_CONST;
}
