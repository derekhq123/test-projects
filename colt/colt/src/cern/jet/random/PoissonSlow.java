...
public void setShared(PoissonSlow shared) {
	this.shared = shared;
}
public void setCached_g(double cached_g) {
	this.cached_g = cached_g;
}
public void setCached_alxm(double cached_alxm) {
	this.cached_alxm = cached_alxm;
}
public void setCached_sq(double cached_sq) {
	this.cached_sq = cached_sq;
}
}
