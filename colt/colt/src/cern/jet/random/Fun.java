...
public static double _fkt_value(double lambda, double z1, double z2, double x_value) {
	double y_value;
...
public static double fkt2_value(double lambda, double beta, double x_value) {
	double y_value;
