...
public static double f(int k, double l_nu, double c_pm) {
...
public void setShared(Poisson shared) {
	this.shared = shared;
}
...
public void setMy_last(double my_last) {
	this.my_last = my_last;
}
public void setLlll(int llll) {
	this.llll = llll;
}
...
public void setMy_old(double my_old) {
	this.my_old = my_old;
}
}
