 ...
 */
public double[] getValuesAtPositions(DoubleBuffer[] buffers, long[] triggerPositions) {
	//if (buffers.length==0) 
	//{
...
public void setNextTriggerCalculationState(boolean nextTriggerCalculationState) {
	this.nextTriggerCalculationState = nextTriggerCalculationState;
}
public void setBuffers(DoubleBuffer[] buffers) {
