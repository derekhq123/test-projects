 ...
 */
public void addInfinities(int missingInfinities,  DoubleBuffer buffer) {
 ...
 * Not yet commented.
 */
public DoubleBuffer[] buffersToCollapse() {
 ...
 * Not yet commented.
 */
public void postCollapse(DoubleBuffer[] toCollapse) {
	this.weHadMoreThanOneEmptyBuffer = false;
}
/**
 */
 ...
 */
public void removeInfinitiesFrom(int infinities, DoubleBuffer buffer) {
	int plusInf = 0;
	int minusInf = 0;
...
public void setSamplingAssistant(RandomSamplingAssistant samplingAssistant) {
	this.samplingAssistant = samplingAssistant;
}
public void setWeHadMoreThanOneEmptyBuffer(boolean weHadMoreThanOneEmptyBuffer) {
	this.weHadMoreThanOneEmptyBuffer = weHadMoreThanOneEmptyBuffer;
}
