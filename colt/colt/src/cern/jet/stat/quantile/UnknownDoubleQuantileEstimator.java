 ...
 */
public static void sortAscendingByLevel(DoubleBuffer[] fullBuffers) {
...
public void setPrecomputeEpsilon(double precomputeEpsilon) {
	this.precomputeEpsilon = precomputeEpsilon;
}
public void setSampler(WeightedRandomSampler sampler) {
	this.sampler = sampler;
}
public void setCurrentTreeHeight(int currentTreeHeight) {
