...
public class Format
{
  ...
  */
   ...
   */
   ...
   public static String convert(long x, int n, int m, String d)
   {
	  if (x == 0) return "0";
	  String r = "";
	  while (x != 0)
   ...
   public String sign(int s, String r)
   {
	  String p = "";
	  if (s < 0) p = "-";
	  else if (s > 0)
   ...
   public String fixedFormat(double d)
   {
   ...
   public String expFormat(double d)
   {
	  String f = "";
	  int e = 0;
	  double dd = d;
