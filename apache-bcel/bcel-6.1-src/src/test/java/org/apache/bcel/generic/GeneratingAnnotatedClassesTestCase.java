...
public class GeneratingAnnotatedClassesTestCase extends AbstractTestCase
{
    ...
    public void assertMethodAnnotations(final Method method, final int expectedNumberAnnotations, final int nExpectedArrayValues)
    {
        final String methodName= method.getName();
    ...
    public void assertArrayElementValue(final int nExpectedArrayValues, final AnnotationEntry anno)
    {
    ...
    public void assertParameterAnnotations(final Method method, final int... expectedNumberOfParmeterAnnotations)
    {
    ...
    public void assertSimpleElementValue(final AnnotationEntry anno)
    {
        final ElementValuePair elementValuePair = anno.getElementValuePairs()[0];
    ...
    public void dumpClass(final ClassGen cg, final String fname)
    {
        try
        {
    ...
    public void dumpClass(final ClassGen cg, final String dir, final String fname)
    {
        dumpClass(cg, dir + File.separator + fname);
    }

    public void buildClassContentsWithAnnotatedMethods(final ClassGen cg,
    ...
    public void buildClassContents(final ClassGen cg, final ConstantPoolGen cp,
    ...
    public JavaClass getClassFrom(final String where, final String clazzname)
            throws ClassNotFoundException
    {
    ...
    // helper methods
    public ClassGen createClassGen(final String classname)
    {
        return new ClassGen(classname, "java.lang.Object", "<generated>",
                Const.ACC_PUBLIC | Const.ACC_SUPER, null);
    }

    public MethodGen createMethodGen(final String methodname, final InstructionList il,
