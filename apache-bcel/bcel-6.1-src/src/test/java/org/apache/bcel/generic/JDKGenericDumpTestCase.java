...
public class JDKGenericDumpTestCase {
    ...
    public static Set<String> findJavaHomes() {
    ...
    public static Set<String> findJavaHomesOnWindows() {
    ...
    public static Set<String> findJavaHomesOnWindows(final String[] keys) {
    ...
    public void testJar(final File file) throws Exception {
    ...
    public void compare(final String name, final Method m) {
    ...
    public File[] listJDKjars() throws Exception {
