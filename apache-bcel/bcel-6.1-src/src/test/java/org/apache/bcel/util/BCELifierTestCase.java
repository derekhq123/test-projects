...
public class BCELifierTestCase {
    ...
    public void testClassOnPath(final String javaClass) throws Exception {
    ...
    public String canonHashRef(String input) {
    ...
    public String exec(final File workDir, final String... args) throws Exception {
