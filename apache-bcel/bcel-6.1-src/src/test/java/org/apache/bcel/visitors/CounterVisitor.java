...
public class CounterVisitor implements Visitor
{
	...
	public void setConstantPackageCount(int constantPackageCount) {
		this.constantPackageCount = constantPackageCount;
	}

	public void setConstantModuleCount(int constantModuleCount) {
		this.constantModuleCount = constantModuleCount;
	}

	public void setConstantInvokeDynamic(int constantInvokeDynamic) {
		this.constantInvokeDynamic = constantInvokeDynamic;
	}
	...
	public void setBootstrapMethodsCount(int bootstrapMethodsCount) {
		this.bootstrapMethodsCount = bootstrapMethodsCount;
	}
	...
	public void setAnnotationDefaultCount(int annotationDefaultCount) {
		this.annotationDefaultCount = annotationDefaultCount;
	}

	public void setAnnotationEntryCount(int annotationEntryCount) {
		this.annotationEntryCount = annotationEntryCount;
	}
	...
	public void setCodeExceptionCount(int codeExceptionCount) {
		this.codeExceptionCount = codeExceptionCount;
	}

	public void setConstantDoubleCount(int constantDoubleCount) {
		this.constantDoubleCount = constantDoubleCount;
	}

	public void setConstantClassCount(int constantClassCount) {
		this.constantClassCount = constantClassCount;
	}

	public void setConstantFieldrefCount(int constantFieldrefCount) {
		this.constantFieldrefCount = constantFieldrefCount;
	}

	public void setConstantFloatCount(int constantFloatCount) {
		this.constantFloatCount = constantFloatCount;
	}

	public void setConstantInterfaceMethodrefCount(int constantInterfaceMethodrefCount) {
		this.constantInterfaceMethodrefCount = constantInterfaceMethodrefCount;
	}

	public void setConstantIntegerCount(int constantIntegerCount) {
		this.constantIntegerCount = constantIntegerCount;
	}

	public void setConstantLongCount(int constantLongCount) {
		this.constantLongCount = constantLongCount;
	}

	public void setConstantMethodrefCount(int constantMethodrefCount) {
		this.constantMethodrefCount = constantMethodrefCount;
	}
	...
	public void setConstantNameAndTypeCount(int constantNameAndTypeCount) {
		this.constantNameAndTypeCount = constantNameAndTypeCount;
	}

	public void setConstantStringCount(int constantStringCount) {
		this.constantStringCount = constantStringCount;
	}

	public void setConstantUtf8Count(int constantUtf8Count) {
		this.constantUtf8Count = constantUtf8Count;
	}

	public void setConstantValueCount(int constantValueCount) {
		this.constantValueCount = constantValueCount;
	}
	...
	public void setEnclosingMethodCount(int enclosingMethodCount) {
		this.enclosingMethodCount = enclosingMethodCount;
	}

	public void setExceptionTableCount(int exceptionTableCount) {
	...
	public void setInnerClassesCount(int innerClassesCount) {
		this.innerClassesCount = innerClassesCount;
	}

	public void setJavaClassCount(int javaClassCount) {
		this.javaClassCount = javaClassCount;
	}

	public void setLineNumberCount(int lineNumberCount) {
		this.lineNumberCount = lineNumberCount;
	}

	public void setLineNumberTableCount(int lineNumberTableCount) {
		this.lineNumberTableCount = lineNumberTableCount;
	}
	...
	public void setLocalVariableTableCount(int localVariableTableCount) {
		this.localVariableTableCount = localVariableTableCount;
	}

	public void setLocalVariableTypeTableCount(int localVariableTypeTableCount) {
		this.localVariableTypeTableCount = localVariableTypeTableCount;
	}
	...
	public void setParameterAnnotationCount(int parameterAnnotationCount) {
		this.parameterAnnotationCount = parameterAnnotationCount;
	}

	public void setSignatureAnnotationCount(int signatureAnnotationCount) {
		this.signatureAnnotationCount = signatureAnnotationCount;
	}
	...
	public void setStackMapCount(int stackMapCount) {
		this.stackMapCount = stackMapCount;
	}

	public void setStackMapEntryCount(int stackMapEntryCount) {
		this.stackMapEntryCount = stackMapEntryCount;
	}

	public void setSyntheticCount(int syntheticCount) {
