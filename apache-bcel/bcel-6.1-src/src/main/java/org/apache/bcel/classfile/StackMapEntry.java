...
public final class StackMapEntry implements Node, Cloneable
{
	...
	public void setTypes_of_stack_items(StackMapType[] types_of_stack_items) {
		this.types_of_stack_items = types_of_stack_items;
	}

	public void setTypes_of_locals(StackMapType[] types_of_locals) {
		this.types_of_locals = types_of_locals;
	}

	public void setByte_code_offset(int byte_code_offset) {
