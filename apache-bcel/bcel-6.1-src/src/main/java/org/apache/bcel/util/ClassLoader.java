...
public class ClassLoader extends java.lang.ClassLoader {
    ...
    @Override
    public Class<?> loadClass( final String class_name, final boolean resolve ) throws ClassNotFoundException {
        Class<?> cl = null;
     ...
     */
    public JavaClass createClass( final String class_name ) {
