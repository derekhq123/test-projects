...
//ExecutionVisitor ev = ExecutionVisitor.getInstance(VerifierFactory.getVerifier(method_gen.getClassName()));
         ...
         */
        public boolean mergeInFrames(final Frame inFrame) {
         ...
         */
        public void extendMessageWithFlow(final StructuralCodeConstraintException e) {
         ...
         */
        public InstructionContextImpl lastExecutionJSR() {
...
// TODO: implement caching!
        public InstructionHandle[] _getSuccessors() {
