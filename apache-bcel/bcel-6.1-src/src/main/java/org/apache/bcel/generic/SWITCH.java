...
public final class SWITCH implements CompoundInstruction {
    ...
    public void fillup( final int max_gap, final InstructionHandle target ) {
     ...
     */
    public void sort( final int l, final int r ) {
        int i = l;
        int j = r;
        int h;
     ...
     */
    public boolean matchIsOrdered( final int max_gap ) {
        for (int i = 1; i < match_length; i++) {
	...
	public void setMatch_length(int match_length) {
		this.match_length = match_length;
	}


	public void setInstruction(Select instruction) {
		this.instruction = instruction;
	}


	public void setTargets(InstructionHandle[] targets) {
