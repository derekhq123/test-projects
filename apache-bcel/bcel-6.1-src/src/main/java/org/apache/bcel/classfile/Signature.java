...
public final class Signature extends Attribute {
    ...
    public static boolean identStart( final int ch ) {
        return ch == 'T' || ch == 'L';
    }


    public static void matchIdent( final MyByteArrayInputStream in, final StringBuilder buf ) {
        int ch;
        if ((ch = in.read()) == -1) {
    ...
    public static void matchGJIdent( final MyByteArrayInputStream in, final StringBuilder buf ) {
        int ch;
        matchIdent(in, buf);
        ch = in.read();
