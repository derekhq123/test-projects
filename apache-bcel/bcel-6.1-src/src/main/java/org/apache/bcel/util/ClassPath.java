...
public class ClassPath {
    ...
    public static void getPathComponents( final String path, final List<String> list ) {
        if (path != null) {
    ...
    public ClassFile getClassFileInternal(final String name, final String suffix) throws IOException {
