...
public final class CodeExceptionGen implements InstructionTargeter, Cloneable {
	...
	public void setCatch_type(ObjectType catch_type) {
		this.catch_type = catch_type;
	}


	public void setHandler_pc(InstructionHandle handler_pc) {
		this.handler_pc = handler_pc;
	}


	public void setEnd_pc(InstructionHandle end_pc) {
		this.end_pc = end_pc;
	}


	public void setStart_pc(InstructionHandle start_pc) {
		this.start_pc = start_pc;
	}
}
