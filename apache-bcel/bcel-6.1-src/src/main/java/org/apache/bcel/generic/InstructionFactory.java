 ...
 */
    ...
    public InvokeInstruction createInvoke( final MethodObject m, final short kind ) {
    ...
    public static ArithmeticInstruction createBinaryIntOp( final char first, final String op ) {
        switch (first) {
            case '-':
    ...
    public static ArithmeticInstruction createBinaryLongOp( final char first, final String op ) {
        switch (first) {
            case '-':
    ...
    public static ArithmeticInstruction createBinaryFloatOp( final char op ) {
        switch (op) {
            case '-':
    ...
    public static ArithmeticInstruction createBinaryDoubleOp( final char op ) {
        switch (op) {
            case '-':
	...
	public void setCp(ConstantPoolGen cp) {
		this.cp = cp;
	}
