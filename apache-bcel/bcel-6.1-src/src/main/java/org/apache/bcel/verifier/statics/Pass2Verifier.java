...
public final class Pass2Verifier extends PassVerifier implements Constants {
     ...
     */
    public void every_class_has_an_accessible_superclass() {
        try {
     ...
     */
    public void final_methods_are_not_overridden() {
        try {
     ...
     * @throws ClassConstraintException otherwise.
     */
    public void constant_pool_entries_satisfy_static_constraints() {
        try {
    ...
    private final class CPESSC_Visitor extends org.apache.bcel.classfile.EmptyVisitor{
        ...
        */
        ...
        public CPESSC_Visitor(final JavaClass _jc) {
            jc = _jc;
        ...
        public void checkIndex(final Node referrer, final int index, final Class<?> shouldbe) {
     ...
     * @see #constant_pool_entries_satisfy_static_constraints()
     */
    public void field_and_method_refs_are_valid() {
        try {
        final JavaClass jc = Repository.lookupClass(myOwner.getClassName());
    ...
    private final class FAMRAV_Visitor extends EmptyVisitor{
        ...
        public FAMRAV_Visitor(final JavaClass _jc) {
            cp = _jc.getConstantPool();
        }
     ...
     */
    public static boolean validClassName(final String name) {
        /*
         * TODO: implement.
     ...
     */
    public static boolean validMethodName(final String name, final boolean allowStaticInit) {
     ...
     */
    public static boolean validClassMethodName(final String name) {
     ...
     */
    public static boolean validJavaLangMethodName(final String name) {
     ...
     */
    public static boolean validInterfaceMethodName(final String name) {
     ...
     */
    public static boolean validJavaIdentifier(final String name) {
    if  (name.length() == 0) {
     ...
     */
    public static boolean validFieldName(final String name) {
        // vmspec2 2.7, vmspec2 2.2
	...
	public void setLocalVariablesInfos(LocalVariablesInfo[] localVariablesInfos) {
		this.localVariablesInfos = localVariablesInfos;
	}
}
