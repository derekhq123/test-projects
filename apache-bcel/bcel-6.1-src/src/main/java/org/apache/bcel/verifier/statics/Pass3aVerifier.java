...
public final class Pass3aVerifier extends PassVerifier{
     ...
     * @see #do_verify()
     */
    public void delayedPass2Checks() {
     ...
     */
    public void pass3StaticInstructionChecks() {
     ...
     * @throws StaticCodeConstraintException if the verification fails.
     */
    public void pass3StaticInstructionOperandsChecks() {
        try {
    ...
    public static boolean contains(final int[] ints, final int i) {
    ...
    private class InstOperandConstraintVisitor extends org.apache.bcel.generic.EmptyVisitor{
         ...
         */
        public void constraintViolated(final Instruction i, final String message) {
         ...
         */
        public void indexValid(final Instruction i, final int idx) {
        ...
        public ObjectType getObjectType(final FieldInstruction o) {
...
//                Type o_type = o.getType(cpg);
         ...
         */
        public Method getMethodRecursive(final JavaClass jc, final InvokeInstruction invoke) throws ClassNotFoundException{
            Method m;
         ...
         * @return the referenced method or null if not found.
         */
        public Method getMethod(final JavaClass jc, final InvokeInstruction invoke) {
         ...
         */
        public boolean objarrayequals(final Object[] o, final Object[] p) {
