...
public final class Method extends FieldOrMethod {
	...
	public void setParameterAnnotationEntries(ParameterAnnotationEntry[] parameterAnnotationEntries) {
		this.parameterAnnotationEntries = parameterAnnotationEntries;
	}
