...
public abstract class Utility {
    ...
    public static int unwrap( final ThreadLocal<Integer> tl ) {
        return tl.get().intValue();
    }


    public static void wrap( final ThreadLocal<Integer> tl, final int value ) {
    ...
    public static int countBrackets( final String brackets ) {
