...
public class Subroutines{
    ...
    private class SubroutineImpl implements Subroutine{
         ...
         */
        public void _getRecursivelyAccessedLocalsIndicesHelper(final Set<Integer> s, final Subroutine[] subs) {
     ...
     */
    public void noRecursiveCalls(final Subroutine sub, final Set<Integer> set) {
...
System.err.println("DEBUG: Please verify '"+any.toString(true)+"' lies in dead code.");
     ...
     */
    public static InstructionHandle[] getSuccessors(final InstructionHandle instruction) {
