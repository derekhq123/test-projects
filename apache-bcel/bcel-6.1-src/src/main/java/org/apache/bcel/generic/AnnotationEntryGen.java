...
public class AnnotationEntryGen {
    ...
    public List<ElementValuePairGen> copyValues(final ElementValuePair[] in, final ConstantPoolGen cpool,
                                                 final boolean copyPoolEntries) {
    ...
    public AnnotationEntryGen(final ConstantPoolGen cpool) {
        this.cpool = cpool;
    }
    ...
    public void isRuntimeVisible(final boolean b) {
        isRuntimeVisible = b;
    }
	...
	public void setIsRuntimeVisible(boolean isRuntimeVisible) {
