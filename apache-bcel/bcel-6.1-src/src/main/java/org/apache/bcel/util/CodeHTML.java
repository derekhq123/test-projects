...
//        this.methods = methods;
     ...
     */
    public String codeToHTML( final ByteSequence bytes, final int method_number ) throws IOException {
...
//                    int reserved = bytes.readUnsignedByte(); // Reserved
     ...
     */
    public void findGotos( final ByteSequence bytes, final Code code ) throws IOException {
        int index;
...
//                            int match = bytes.readInt();
     ...
     */
    public void writeMethod( final Method method, final int method_number ) throws IOException {
        // Get raw signature
	...
	public void setGoto_set(BitSet goto_set) {
		this.goto_set = goto_set;
	}
}
