...
public class InstConstraintVisitor extends EmptyVisitor{
   ...
   */
    public void constraintViolated(final Instruction violator, final String description) {
     ...
     */
    public void indexOfInt(final Instruction o, final Type index) {
     ...
     * @throws StructuralCodeConstraintException if the above constraint is not satisfied.
     */
    public void referenceTypeIsInitialized(final Instruction o, final ReferenceType r) {
    ...
    public void valueOfInt(final Instruction o, final Type value) {
     ...
     * @throws StructuralCodeConstraintException if the above constraint is violated.
      */
    public boolean arrayrefOfArrayType(final Instruction o, final Type arrayref) {
     ...
     */
    public void _visitStackAccessor(final Instruction o) {
