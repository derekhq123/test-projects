...
public class LocalVariableInfo{
     ...
     * (Hashtable) database.
     */
    public void setName(final int offset, final String name) {
     ...
     * (Hashtable) database.
     */
    public void setType(final int offset, final Type t) {
     ...
     *         with already gathered information.
     */
    public void add(final int offset, final String name, final Type t) throws LocalVariableInfoInconsistentException{
