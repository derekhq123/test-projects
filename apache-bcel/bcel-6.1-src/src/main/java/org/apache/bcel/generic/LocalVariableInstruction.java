 ...
 *
 * @version $Id: LocalVariableInstruction.java 1806200 2017-08-25 16:33:06Z ggregory $
 */
public abstract class LocalVariableInstruction extends Instruction implements TypedInstruction,
     ...
     */
    public LocalVariableInstruction(final short opcode, final short c_tag, final int n) {
