 ...
 *
 * @version $Id: MethodGen.java 1806728 2017-08-30 19:34:23Z britter $
 * @see     InstructionList
 * @see     Method
 */
public class MethodGen extends FieldGenOrMethodGen {
     ...
     */
    public ExceptionTable getExceptionTable( final ConstantPoolGen cp ) {
    ...
    public void updateLocalVariableTable(final LocalVariableTable a) {
    ...
    public void adjustLocalVariableTypeTable(final LocalVariableTable lvt) {
    ...
    static final class BranchStack {
        ...
        public BranchTarget visit( final InstructionHandle target, final int stackDepth ) {
        ...
        public boolean visited( final InstructionHandle target ) {
    ...
    public List<AnnotationEntryGen> makeMutableVersion(final AnnotationEntry[] mutableArray)
    {
	...
	public void setLocal_variable_type_table(LocalVariableTypeTable local_variable_type_table) {
		this.local_variable_type_table = local_variable_type_table;
	}


	public void setStrip_attributes(boolean strip_attributes) {
		this.strip_attributes = strip_attributes;
	}
	...
	public void setArg_names(String[] arg_names) {
		this.arg_names = arg_names;
	}


	public void setArg_types(Type[] arg_types) {
		this.arg_types = arg_types;
	}
	...
	public void setBcelComparator(BCELComparator bcelComparator) {
		this.bcelComparator = bcelComparator;
	}


	public void setHaveUnpackedParameterAnnotations(boolean haveUnpackedParameterAnnotations) {
		this.haveUnpackedParameterAnnotations = haveUnpackedParameterAnnotations;
	}


	public void setHasParameterAnnotations(boolean hasParameterAnnotations) {
		this.hasParameterAnnotations = hasParameterAnnotations;
	}


	public void setParam_annotations(List<AnnotationEntryGen>[] param_annotations) {
		this.param_annotations = param_annotations;
	}
